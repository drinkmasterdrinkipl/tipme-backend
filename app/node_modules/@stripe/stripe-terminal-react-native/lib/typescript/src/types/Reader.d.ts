...
export declare namespace Reader {
    ...
    type SimulateUpdateType = 'random' | 'available' | 'none' | 'required' | 'lowBattery' | 'lowBatterySucceedConnect' | 'requiredForOffline';
    type DeviceType = 'chipper1X' | 'chipper2X' | 'stripeM2' | 'wiseCube' | 'wisePad3' | 'wisePosE' | 'wisePosEDevkit' | 'wisePad3s' | 'stripeS700Devkit' | 'stripeS700' | 'stripeS710Devkit' | 'stripeS710' | 'cotsDevice' | 'tapToPay' | 'etna';
